...
%=============================================================================')
%Problem: The city is mapped into a 7 km x 7 km. A number in each sector of the')
%         grid represents an average number of emergencies per year in a given ')
%         sector.')
%=============================================================================')
...
% title(['coordinates # ',num2str(m*n_show),'  The total distance: ',num2str(a)]);
% grid on
% hold on
